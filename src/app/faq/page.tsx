...
const FAQ_DATA = [
  ...
  {"question":"Will my content actually sound human or like a robot who just discovered emojis?","answer":"It's built on the rhythm of late-night marketer rants and the regret of campaigns past. If it flops, you can still blame the system\u2014we won't take it personally (okay, maybe a little)."},
